...
const dynamicPeriods = Math.max(Number(process.env.DYNAMIC_PERIODS ?? MINIMUM_GAME_DAYS), MINIMUM_GAME_DAYS);
...
async function main() {
  ...
  const runConfigs = [
    { name: "Static Round 1", type: "STATIC", capacity: defaultCapacity("STATIC", participantCount), dynamicPeriods: MINIMUM_GAME_DAYS },
    { name: "Static Round 2", type: "STATIC", capacity: defaultCapacity("STATIC", participantCount), dynamicPeriods: MINIMUM_GAME_DAYS },
    { name: "Dynamic Pricing Game", type: "DYNAMIC", capacity: defaultCapacity("DYNAMIC", participantCount), dynamicPeriods },
    { name: "Postscreening Game", type: "POSTSCREENING", capacity: defaultCapacity("POSTSCREENING", participantCount), dynamicPeriods: MINIMUM_GAME_DAYS, segmentCutoff: 3500 }
  ];
